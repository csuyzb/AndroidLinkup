...
import com.znv.linkup.base.Game;
import com.znv.linkup.base.IGameOp;
...
import com.znv.linkup.base.status.GameCombo;
import com.znv.linkup.util.ImageUtil;
...
import com.znv.linkup.view.animation.path.CoinImageView;
import com.znv.linkup.view.animation.path.CoinPathAnimator;
...
public class GameActivity extends FullScreenActivity implements IGameOp {
    ...
    class LevelHolder {
        ...
        Bitmap bmSelected;
        CoinPathAnimator startCoin;
        CoinPathAnimator endCoin;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        holder.startCoin = new CoinPathAnimator((CoinImageView) findViewById(R.id.startCoin));
        holder.endCoin = new CoinPathAnimator((CoinImageView) findViewById(R.id.endCoin));
        holder.flBackground = (FrameLayout) findViewById(R.id.frame);
    ...
    public void start() {
        ...
        gameView.setGameService(game.getGameService());
