...
import com.znv.linkup.base.card.align.GameAlign;
...
public class GameCfg {
    ...
    private void LoadGlobalCfg(XmlResourceParser xrp) {
        ...
        // gamecfg.setGameWidth(Integer.parseInt(xrp.getAttributeValue(null, "gwidth")));
        // gamecfg.setGameHeight(Integer.parseInt(xrp.getAttributeValue(null, "gheight")));
        gamecfg.setGameSkin(xrp.getAttributeValue(null, "gskin"));
        gamecfg.setGameMusic(xrp.getAttributeValue(null, "gmusic").equals("1"));
    ...
    private LevelCfg LoadLevelCfg(XmlResourceParser xrp) {
        ...
        // levelCfg.setPromptNum(Integer.parseInt(xrp.getAttributeValue(null, "prompt")));
        // levelCfg.setPauseNum(Integer.parseInt(xrp.getAttributeValue(null, "pause")));
